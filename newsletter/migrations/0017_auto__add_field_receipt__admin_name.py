...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Receipt._admin_name'
        db.add_column(u'newsletter_receipt', '_admin_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Receipt._admin_name'
        db.delete_column(u'newsletter_receipt', '_admin_name')
    ...
    models = {
        ...
        u'newsletter.subscription': {
            ...
            '_admin_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'21ce63421c591d9e2e1ed4c90abe403b72cff126'", 'max_length': '40'}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
