...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.track_links'
        db.add_column(u'newsletter_newsletter', 'track_links',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.track_links'
        db.delete_column(u'newsletter_newsletter', 'track_links')
    ...
    models = {
        ...
        u'newsletter.subscription': {
            ...
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'5c947a1c8ddafdcb8f63a164481f21eb9654e5fb'", 'max_length': '40'}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
