...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.last_sent_date'
        db.add_column(u'newsletter_subscription', 'last_sent_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.last_sent_date'
        db.delete_column(u'newsletter_subscription', 'last_sent_date')
    ...
    models = {
        ...
        u'newsletter.subscription': {
            ...
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'02361400b6412545ca34131f79afb8d686b90e51'", 'max_length': '40'}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
