...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'newsletter_subscription', ['user_id', 'email', 'newsletter_id'])

        # Deleting field 'Subscription.name_field'
        db.delete_column(u'newsletter_subscription', 'name')

        # Deleting field 'Subscription.email_field'
        db.delete_column(u'newsletter_subscription', 'email')

        # Adding unique constraint on 'Subscription', fields ['user', 'newsletter']
        db.create_unique(u'newsletter_subscription', ['user_id', 'newsletter_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Subscription', fields ['user', 'newsletter']
        db.delete_unique(u'newsletter_subscription', ['user_id', 'newsletter_id'])

        # Adding field 'Subscription.name_field'
        db.add_column(u'newsletter_subscription', 'name_field',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, db_column='name', blank=True),
                      keep_default=False)

        # Adding field 'Subscription.email_field'
        db.add_column(u'newsletter_subscription', 'email_field',
                      self.gf('django.db.models.fields.EmailField')(blank=True, max_length=75, null=True, db_column='email', db_index=True),
                      keep_default=False)

        # Adding unique constraint on 'Subscription', fields ['user', 'email_field', 'newsletter']
        db.create_unique(u'newsletter_subscription', ['user_id', 'email', 'newsletter_id'])
    ...
    models = {
        ...
        u'newsletter.subscription': {
            'Meta': {'ordering': "('_admin_name',)", 'unique_together': "(('user', 'newsletter'),)", 'object_name': 'Subscription'},
            '_admin_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'ccb2ddd655b430fecc9376511be31dddfdd1c241'", 'max_length': '40'}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
