...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'newsletter_article')

        # Adding field 'Message.text'
        db.add_column(u'newsletter_message', 'text',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'newsletter_article', (
        ...
        db.send_create_signal(u'newsletter', ['Article'])

        # Deleting field 'Message.text'
        db.delete_column(u'newsletter_message', 'text')
    ...
    models = {
        ...
        u'newsletter.subscription': {
            ...
            '_admin_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'f4ccce6fa8fd626b53caef20512cccefc5b28f30'", 'max_length': '40'}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
