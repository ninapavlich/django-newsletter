...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Receipt.message'
        db.add_column(u'newsletter_receipt', 'message',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['newsletter.Message'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LinkTrack.submission'
        db.delete_column(u'newsletter_linktrack', 'submission_id')

        # Adding field 'LinkTrack.message'
        db.add_column(u'newsletter_linktrack', 'message',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['newsletter.Message'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Message.send_date'
        db.add_column(u'newsletter_message', 'send_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Message.prepared'
        db.add_column(u'newsletter_message', 'prepared',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Message.prepared_date'
        db.add_column(u'newsletter_message', 'prepared_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Message.sending'
        db.add_column(u'newsletter_message', 'sending',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Message.sending_date'
        db.add_column(u'newsletter_message', 'sending_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Message.sent'
        db.add_column(u'newsletter_message', 'sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Message.sent_date'
        db.add_column(u'newsletter_message', 'sent_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Receipt.message'
        db.delete_column(u'newsletter_receipt', 'message_id')

        # Adding field 'LinkTrack.submission'
        db.add_column(u'newsletter_linktrack', 'submission',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['newsletter.Submission']),
                      keep_default=False)

        # Deleting field 'LinkTrack.message'
        db.delete_column(u'newsletter_linktrack', 'message_id')

        # Deleting field 'Message.send_date'
        db.delete_column(u'newsletter_message', 'send_date')

        # Deleting field 'Message.prepared'
        db.delete_column(u'newsletter_message', 'prepared')

        # Deleting field 'Message.prepared_date'
        db.delete_column(u'newsletter_message', 'prepared_date')

        # Deleting field 'Message.sending'
        db.delete_column(u'newsletter_message', 'sending')

        # Deleting field 'Message.sending_date'
        db.delete_column(u'newsletter_message', 'sending_date')

        # Deleting field 'Message.sent'
        db.delete_column(u'newsletter_message', 'sent')

        # Deleting field 'Message.sent_date'
        db.delete_column(u'newsletter_message', 'sent_date')
    ...
    models = {
        ...
        u'newsletter.subscription': {
            ...
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'e7d14139ec8b070474c24f7f793b6c8ed313d1dd'", 'max_length': '40'}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
        ...
        u'newsletter.subscriptiongroup': {
            'Meta': {'ordering': "('title',)", 'object_name': 'SubscriptionGroup'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
